  ...
  return (
    <div className="flex justify-center pt-40 relative">
      <div className="absolute top-10 left-0 right-0 h-1/2 flex justify-center ">
        <img
          src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiIaegGt7S4upfAgF4iaO0T_E1t-CXHOYsW4v04h_LkPUbB0ychPZFaQPD8vlBKuIllv0bwrufdNLBtgi9_YEUyzgb-uNStntcbF6_z0I01NQNoGIEuwGNG8F2RXQIxqSRVkoDWbUF1lLTMBJT1S3YjJeH7cnruO8XYzR_zlFZD9cc5CHztux07lTLB/s728-rw-e365/uber.gif"
          alt="Hacker Meme"
          className="w-22 h-22 object-cover shadow-lg rounded-lg"
        />
      </div>
